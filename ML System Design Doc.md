...
Работа в реальном времени или близком к нему (задержка ≤ 1 сек).
...
Данные: Изображения вагонов с камер полигона (разрешение ≥ 1080p).
Гранулярность: Определение стороны вагона (бинарная классификация: левая/правая).
