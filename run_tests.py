...
def main():
    ...
    parser.add_argument(
        '--lf',
        action='store_true',
        help='Запустить последние неудачные тесты'
    )

    parser.add_argument(
        '--pdb',
        action='store_true',
        help='Запустить отладчик при ошибке'
    )

    parser.add_argument(
        '--markers', '-m',
        type=str,
        help='Запустить тесты с определённым маркером'
    )

    parser.add_argument(
        '--keyword', '-k',
        type=str,
        help='Запустить тесты на основе выражения'
    )
